...
var changeModalState = function changeModalState(state) {
  ...
  function bindActionToElem(event, elem, prop) {
    //bind action wich writes something to state when event occurs on elem
          ...
          case 'INPUT':
            if (item.getAttribute('type') === "checkbox") {
              ...
              elem.forEach(function (box, j) {
                ...
                if (i == j) {
                  // if element in foreach is one user has clicked then stays true
                  box.checked = true;
                }
              });
            } else {
...
var modals = function modals(state) {
  function bindModal(triggerSelector, closeSelector, modalSelector) {
    ...
    var checkFillInputs = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    var shouldBeInputted = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : [];
    var resetOnClose = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
    ...
    trigger.forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        if (!checkFillInputs || checkFillInputs && shouldBeInputted.every(function (v) {
  ...
  bindModal(".popup_calc_btn", ".popup_calc_close", ".popup_calc", true, false, [], true);
  bindModal(".popup_calc_button", ".popup_calc_profile_close", ".popup_calc_profile", false, true, ["form", "width", "height"], true);
  bindModal(".popup_calc_profile_button", ".popup_calc_end_close", ".popup_calc_end", false, true, ["type", "profile"], true); //showModalByTime(".popup", 60000);
};
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemaining = function getTimeRemaining(endtime) {
    ...
    seconds = Math.floor(t / 1000 % 60),
        // %60 ostatok ot deleniya kol-va sec na 60
  ...
  var setClock = function setClock(selector, endtime) {
    var timer = document.querySelector(selector),
        ...
        timeInerval = setInterval(updateClock, 1000); // id of the timer to stop it omewhen
